 ...
 */
export const DEFAULT_ACCUMULATOR_CONFIG = {
...
export function createInitialAccumulatorState() {
    return {
        value: 0,
 ...
 */
export function updateAccumulator(current, composite, dimensions, now, config = DEFAULT_ACCUMULATOR_CONFIG) {
 ...
 */
export function meetsConvergence(state, minDimensions) {

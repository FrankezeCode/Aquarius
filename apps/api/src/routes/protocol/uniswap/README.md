...
Protocol-first API module for Uniswap integration in Aquarius DeFi Lab.

## Purpose

This folder contains all Uniswap-specific API logic: internal admin/ingestion routes, chain-specific endpoints, and public signals/streams. Adding or modifying Uniswap behavior requires changes only in this folder.

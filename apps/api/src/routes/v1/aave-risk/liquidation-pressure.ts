/**
 * API-as-a-Product Layer — GET /liquidation-pressure
 *
 * Returns the latest liquidation pressure assessment as a normalized DTO.
...
export function createLiquidationPressureRoute(
  ...
  return async function registerLiquidationPressureRoute(
    app: FastifyInstance,
    _opts: FastifyPluginOptions
  ) {
    // GET /:chain  (e.g. /liquidation-pressure/ethereum)
    app.get<{
      Params: { chain?: string };

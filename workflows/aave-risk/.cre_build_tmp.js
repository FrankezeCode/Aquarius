...
function workflowRunId(workflowName, timestamp) {
...
async function executeAaveRiskWorkflow() {
...
var onCronTrigger = async (runtime2) => {
  ...
  runtime2.log(`[aave-risk] runId=${result.runId} status=${result.status} signals=${result.signals} durationMs=${result.durationMs}`);
  return result;
};
var initWorkflow = () => {
